          ...
          {isListEmpty ? (
            ...
            <div className="d-flex flex-column">
              <div className="d-flex flex-row align-items-center justify-content-between">
                ...
                <Link to="/update-bulk">
                  <Button variant="warning mb-2 mb-md-4">
...
const InvoiceRow = ({ invoice, navigate }) => {
  ...
  },[selectedList,isPresent,invoice.id]);
  ...
  const changeSelectedIds = () => {
    ...
    if (isPresent) dispatch(removeSelectedInvoice(invoice.id));
    else dispatch(addSelectedInvoices(invoice));
  };
