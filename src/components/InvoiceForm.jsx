...
const InvoiceForm = ({ invoiceData, handleInvoiceData }) => {
  ...
  const isEditBulk = location.pathname.includes("update-bulk");
  ...
  useEffect(() => {
    if (isEditBulk) handleInvoiceData(formData);
  }, [invoiceData, formData,isEditBulk]);
